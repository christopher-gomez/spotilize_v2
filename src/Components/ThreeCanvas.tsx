...
export default ({
  ...
  const sceneRef = useRef<THREE.Scene | Array<THREE.Scene> | null>(null);
  ...
  const animID = useRef<string | null>(null);
  useEffect(() => {
  ...
  const animManager = React.useRef<AnimationManager | null>(null);
