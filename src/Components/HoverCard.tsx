...
import { PLAYER_CONTROLS_ZINDEX } from "../Spotify/PlayerComponent.tsx";
...
const HoverCard = ({
  ...
  const cardRect = React.useRef<DOMRect | null>(null);

  const animManRef = React.useRef<AnimationManager | undefined>();
  ...
  const animID = React.useRef<string | null>(null);
  React.useEffect(() => {
