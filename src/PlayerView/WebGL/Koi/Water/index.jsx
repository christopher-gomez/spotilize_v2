...
import foam from '../../../../Assets/Textures/foam.png';
import normals from '../../../../Assets/Textures/normal.jpg';
...
export function Water(props) {
  ...
  const uniforms = React.useMemo(
    () => ({
      ...
      // Opts
      uWaterDepth: { value: 0.4 },
      uWaterShallowColor: { value: new THREE.Color("#56aacb") },
      uWaterShallowColorAlpha: { value: 0.38 },
      uWaterDeepColor: { value: new THREE.Color("#00252e") },
      uWaterDeepColorAlpha: { value: 0.94 },

      uHorizonColor: { value: new THREE.Color("#abeaff") },
      uHorizonDistance: { value: 6.0 },

      uRefractionScale: { value: 0.02 },
      uRefractionSpeed: { value: 0.34 },
      uRefractionStrength: { value: 0.01 },

      uFoamAngle: { value: 360 },
      uFoamSpeed: { value: 0.1 },
      uFoamTiling: { value: 4.63 },
      uFoamDistortion: { value: 1.41 },
      uFoamTexture: { value: foamTexture },
      uFoamColor: { value: new THREE.Color("#c1e6ff") },
      uFoamAlpha: { value: 0.11 },
      ...
      uWaveSteepness: { value: 0.25 },
      uWaveLength: { value: 4.06 },
      uWaveSpeed: { value: 0.12 },
      uWaveDirection: { value: new THREE.Vector3(10, 20, 30) },
      uWaveFalloff: { value: 0.43 },
      uWaveCrestColor: { value: new THREE.Color("#10667c") },
