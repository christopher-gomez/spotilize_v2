export default class Animation {
  ...
  constructor(
    ...
    private update: (
      progress: number,
      args?: { [updateArg: string]: any }
    ) => void,
    private onAnimationStart:
      | null
      | undefined
      | (() => { [updateArg: string]: any })
      | (() => void) = undefined,
    private onAnimationComplete: null | undefined | (() => void) = undefined,
    private onAnimationCanceled: null | undefined | (() => void) = undefined,
  ...
  stop(cancel: boolean = true) {
    ...
    if (
      cancel &&
      this.onAnimationCanceled !== undefined &&
      this.onAnimationCanceled !== null
    )
      this.onAnimationCanceled();
